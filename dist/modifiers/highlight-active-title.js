...
var highlightActiveTitle = modifier(function highlightActiveTitle(element, [toc]) {
  ...
  toc?.forEach(tocItem => {
    const tocSection = document.querySelector(`section[aria-labelledby="${tocItem.id}"]`);
    if (tocSection) {
...
export { highlightActiveTitle as default };
//# sourceMappingURL=highlight-active-title.js.map
